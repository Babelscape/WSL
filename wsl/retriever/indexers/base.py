...
from wsl.common.upload import upload
from wsl.common.utils import (
    from_cache,
...
from wsl.retriever.indexers.document import Document, DocumentStore
...
class BaseDocumentIndex:
    ...
    def __init__(
        ...
        name_or_path: Union[str, os.PathLike, None] = None,
        device: str = "cpu",
    ) -> None:
        ...
        self.document_path: Union[List[str, os.PathLike]] = []
    ...
    def to(
        self, device_or_precision: Union[str, torch.device, torch.dtype]
    ) -> "BaseDocumentIndex":
        """
    ...
    def get_passages(self, documents: DocumentStore = None) -> List[str]:
        """
            ...
            if index_exists:
                ...
                if is_package_available("faiss"):
                    ...
                    raise ImportError(
                        ...
                        "You can install it with `pip install wsl[faiss]`."
