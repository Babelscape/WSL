...
class InMemoryDocumentIndex(BaseDocumentIndex):
    def __init__(
        self,
        documents: Union[str, List[str], List[Document]] = None,
        embeddings: Optional[torch.Tensor] = None,
        metadata_fields: Optional[List[str]] = None,
        separator: Optional[str] = None,
        name_or_path: Union[str, os.PathLike, None] = None,
        device: str = "cpu",
        precision: Union[str, int, torch.dtype] = 32,
        *args,
        **kwargs,
    ) -> None:
        """
    ...
    def index(
        ...
        # added prefix for passage retrieve
        data = [retriever.passage_prefix + p for p in data]
