...
from wsl.reader.pytorch_modules.hf.modeling_wsl import WSLReaderSample
...
class WSLOutput:
    ...
    Attributes:
        ...
        spans (List[Span]):
            The list of spans generated for the input t
        ...
        windows (Optional[List[WSLReaderSample]]):
    ...
    windows: Optional[List[WSLReaderSample]] = None
        ...
        self_dict = {
            ...
            "candidates": {
                "span": [
                    ...
                    for window in self.candidates.candidates
                ],
                "triplet": [
                    [[doc.to_dict() for doc in documents] for documents in window]
