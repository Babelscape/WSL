...
VERSION = {}  # type: ignore
with open("wsl/version.py", "r") as version_file:
...
setuptools.setup(
    ...
    url="https://github.com/Babelscape/wsl",
    keywords="NLP Sapienza sapienzanlp babelscape deep learning transformer pytorch retriever word sense linking word sense disambiguation reader",
